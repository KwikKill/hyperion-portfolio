    ...
    <div class="">
      ...
      <div class="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mx-auto px-4">
        <div v-for="project in projects" :key="project.id"
          ...
          <img :src="project.image" :alt="project.localizedName" class="w-full h-48 object-cover" />
          <div v-if="project.starred"
          ...
          <div
            class="text-gray-500 dark:text-gray-400 mb-2 text-right absolute top-2 right-2 text-sm bg-gray-200 dark:bg-gray-700 rounded-full px-2 py-1">
            {{ project.date }}
          </div>
