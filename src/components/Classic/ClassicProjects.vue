<template>
  <section id="projects" class="bg-gray-50 pb-20 dark:bg-gray-900">
    <div class="">
      ...
      <h2 class="mb-8 mt-16 bg-gray-200 p-4 text-center text-3xl font-bold text-gray-900 dark:bg-gray-800 dark:text-white">
...
const completedFilteredProjects = computed(() => projects.value.filter((project) => project.completed));
const uncompletedFilteredProjects = computed(() => projects.value.filter((project) => !project.completed));
