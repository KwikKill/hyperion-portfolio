    ...
    <div class="container mx-auto px-4">
      ...
      <div class="flex justify-center mb-8 border-b border-gray-200 dark:border-gray-700">
        <button @click="activeCategory = 'movies'"
          class="px-6 py-3 font-medium text-sm transition-colors duration-200 relative" :class="activeCategory === 'movies'
        ...
        <button @click="activeCategory = 'games'"
          class="px-6 py-3 font-medium text-sm transition-colors duration-200 relative" :class="activeCategory === 'games'
            ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400'
            : 'text-gray-500 hover:text-blue-600 dark:hover:text-blue-400'">
