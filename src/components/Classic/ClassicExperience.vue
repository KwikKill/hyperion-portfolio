  ...
  <section id="experience" class="py-20 bg-gray-50 dark:bg-gray-900">
    <div class="container mx-auto px-4">
      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="relative">
          <!-- Vertical line -->
          <div class="absolute left-0 md:left-1/2 h-full w-0.5 bg-blue-500 dark:bg-blue-400 transform -translate-x-1/2">
          </div>

          <!-- Experience items -->
          <div v-for="(experience, index) in experiences" :key="index" class="mb-12 relative">
            <!-- Timeline dot -->
            <div
              class="absolute left-0 md:left-1/2 w-4 h-4 bg-blue-500 dark:bg-blue-400 rounded-full transform -translate-x-1/2">
            </div>

            <!-- Content container with alternating layout -->
            <div class="ml-8 md:ml-0 md:w-5/12" :class="{
