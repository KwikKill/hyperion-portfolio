    ...
    <div class="container mx-auto px-4">
        ...
        <div class="bg-gray-50 dark:bg-gray-700 p-8 rounded-lg shadow-md">
          ...
          <div class="space-y-6">
            <div v-for="(category, index) in skills" :key="index">
              <h4 class="font-medium text-lg mb-3 text-blue-600 dark:text-blue-400 border-b border-gray-200 dark:border-gray-700 pb-1">
                {{ category.name }}
              </h4>
      ...
      <div class="mt-12 bg-gray-50 dark:bg-gray-700 p-8 rounded-lg shadow-md">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div v-for="(role, index) in associationRoles" :key="index" class="bg-white dark:bg-gray-800 p-4 rounded-md shadow-sm hover:shadow-md transition-shadow">
