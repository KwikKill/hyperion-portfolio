<template>
  <div v-if="preferencesStore.showModal" class="inset-0 flex items-center justify-center z-50">
    ...
    <div class="fixed inset-0 bg-gradient-to-br overflow-hidden" :class="{
    ...
    <div
      ...
      <div class="terminal-header flex justify-between items-center mb-2 pb-2 border-b border-theme-foreground/30 p-2"
        :class="{
      ...
      <div class="px-8 pb-8 bt-2">
        ...
        <div class="text-center mb-8">
          ...
          <div class="mt-4">
            <img src="../assets/logo.png" alt="Logo" class="w-24 h-24 mx-auto rounded-full border-4 shadow-lg" :class="{
              'border-white/20': version !== 'cyberpunk',
        ...
        <!-- Selection Sections -->
        <div class="grid md:grid-cols-2 gap-6 mb-8 overflow-x-auto">
          <!-- Language Selection -->
          <div class="bg-black rounded-xl pb-6 border transition-all duration-500" :class="{
            'cyberpunk-terminal border-theme-foreground/70': version === 'cyberpunk',
            ...
            <div class="space-y-4 mx-6">
              <button @click="setLanguage('en')" class="language-btn w-full relative overflow-hidden group"
                :class="language === 'en' ? 'active-language' : ''">
                <div
                  class="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-800 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                  :class="{ 'opacity-100': language === 'en' }"></div>
                <div class="relative z-10 flex items-center p-4">
                  <div
                    class="flex-shrink-0 w-10 h-10 bg-blue-600/20 rounded-full flex items-center justify-center mr-4 overflow-hidden">
                    <img src="../assets/Flag_UK.svg" alt="English" class="w-full h-full object-cover" />
                  </div>
                  <div class="text-left">
              ...
              <button @click="setLanguage('fr')" class="language-btn w-full relative overflow-hidden group"
                ...
                <div class="relative z-10 flex items-center p-4">
                  <div
                    class="flex-shrink-0 w-10 h-10 bg-blue-600/20 rounded-full flex items-center justify-center mr-4 overflow-hidden">
                    <img src="../assets/Flag_FR.svg" alt="Français" class="w-full h-full object-cover" />
                  </div>
                  <div class="text-left">
          ...
          <div class="bg-black rounded-xl pb-6 border transition-all duration-500" :class="{
            ...
            <div class="space-y-4 mx-6">
              <button @click="setVersion('classic')" class="version-btn w-full relative overflow-hidden group"
              ...
              <button @click="setVersion('cyberpunk')" class="version-btn w-full relative overflow-hidden group"
                :class="version === 'cyberpunk' ? 'active-version-cyber' : ''">
                <div
                  class="absolute inset-0 bg-gradient-to-r from-yellow-500 to-red-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                ...
                <div class="relative z-10 flex items-center p-4">
                  ...
                  <div class="text-left flex flex-col">
                    <div
                      class="text-lg font-medium text-white flex min-[450px]:items-center min-[450px]:flex-row flex-col min-[450px]:gap-2">
                      Cyberpunk
        ...
        <div class="flex justify-center">
          <button @click="confirmSelection" class="confirm-btn relative overflow-hidden group w-full"
            :disabled="!language || !version">
            <div
              class="absolute inset-0 bg-gradient-to-r from-indigo-600 via-purple-600 to-gray-800 opacity-90 group-hover:opacity-100 transition-opacity duration-300"
            ...
            <div class="relative z-10 py-4 px-8 text-white font-medium text-lg flex items-center justify-center">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-2 animate-pulse" viewBox="0 0 20 20"
                fill="currentColor">
