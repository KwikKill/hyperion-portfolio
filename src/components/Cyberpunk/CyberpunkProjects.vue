<template>
  <section id="projects" class="cyberpunk-terminal py-20 bg-black relative min-h-screen rounded-md">
    ...
    <div class="container mx-auto px-4 relative z-10">
      <!-- Desktop header bar -->
      <CyberpunkTerminalWindow class="mb-4" :showIcon="false" noBody>
        <template #title>
      ...
      <!-- Search bar -->
      <CyberpunkTerminalWindow class="mb-8" :noTitle="true">
        <template #body>
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 mt-10">
        ...
        <div v-for="project in filteredProjects" :key="project" class="flex flex-col items-center cursor-pointer group"
          @click="openProject(project)" :class="{ 'search-match': isSearchMatch(project) }"
    ...
    <div v-if="selectedProject" class="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4"
      ...
      <CyberpunkTerminalWindow class="max-w-3xl w-full max-h-[80vh] overflow-y-auto p-4">
        <template #title>
        ...
        <template #body>
          <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="md:w-1/2">
              ...
              <div class="mb-4">
                <h4 class="text-theme-foreground font-mono uppercase text-lg mb-2">{{ isEnglish ? 'TECHNOLOGIES' :
                  'TECHNOLOGIES' }}</h4>
