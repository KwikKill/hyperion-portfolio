  ...
  <section id="experience" class="cyberpunk-terminal py-20 relative min-h-screen">
    ...
    <div class="container mx-auto px-4 z-10 relative flex flex-col gap-8">
      ...
      <div class="relative">
        ...
        <div class="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-cyan-400 via-theme-foreground to-theme-foreground"></div>
        ...
        <div class="space-y-24">
          ...
          >
            <!-- Timeline node -->
            <div class="absolute left-1/2 transform -translate-x-1/2 w-6 h-6 rounded-full bg-black border-2 border-cyan-400 z-20" style="top: -12px;">
              <div class="absolute inset-1 rounded-full bg-cyan-400 animate-pulse"></div>
            </div>

            <!-- Experience card -->
            <div
              class="relative z-10 flex flex-col md:flex-row items-center pt-6"
            ...
            >
              ...
              >
                ...
                <div class="p-6">
                  ...
                  <!-- Achievements -->
                  <div
                    v-if="experience.localizedAchievements.length"
                  >
                    <h4 class="text-cyan-400 mb-2 font-mono text-sm uppercase tracking-wider">
...
.data-streams {
  ...
  bottom: 0;
  background-image:
    linear-gradient(3deg, transparent 0%, transparent 95%, rgba(211, 196, 35, 0.2) 100%),
    linear-gradient(93deg, transparent 0%, transparent 95%, rgba(211, 196, 35, 0.2) 100%);
