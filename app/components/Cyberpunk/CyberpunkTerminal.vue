...
onMounted(() => {
  ...
  if (isEnglish.value) {
    lines = [
      ...
      { type: 'response', text: 'Gabriel Blaisot (kwikkill) - Software Engineer & Freelance Web Developer' },
    ...
    lines = [
      { type: 'command', text: 'whoami' },
      { type: 'response', text: 'Gabriel Blaisot (kwikkill) - Ingénieur Informatique & Développeur Web Freelance' },
